...
export default function Template(props) {
  ...
  const frontmatterAppData = _get(
    props.data,
    'markdownRemark.frontmatter.appData'
  )
  ...
  return (
    <ContentLayout>
      ...
      <AppContainer py={0} width={1} justifyContent="center">
        <WidthContainer>
            ...
            <Box width={1}>
              <Results
                ...
                searchParams={{
                  ...
                  age_until: _get(
                    props.pageContext,
                    'appData.search.age_until'
                  ),
                  q: _get(props.pageContext, 'appData.search.q'),
                  cc: _get(props.pageContext, 'appData.search.cc'),
                }}
              />
            </Box>
            <Box>
