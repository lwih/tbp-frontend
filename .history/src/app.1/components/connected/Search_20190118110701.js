...
class SearchContainer extends Component {
  ...
  constructor(props) {
    ...
    this._handleChange = this
      ._handleChange
      .bind(this)
    this._handleSelectProduct = this
  ...
  _handleSubmit(term) {
    this
      .props
      .history
      .push(routeToResultsForTerm(term, null, this.props.ages))
  }
  ...
  _handleSelectProduct(product) {
    this
      .props
      .history
      .push(routeToResultsForProduct(product.id, this.props.term, product.category, this.props.ages))
  }
  ...
  render() {
    return ReactDOM.createPortal(
      ...
      flexBasis="100%"
      flexWrap="wrap"
      className="SearchContainer fadeIn duration-500">
      <SearchForm
        term={this.props.term}
        onChange={this._handleChange}
        onSelect={this._handleSelectProduct}
        onSubmit={this._handleSubmit}/>
    </Flexbox>, getOrCreateElementById('div', {id: 'SearchContainer'}))
  }
}
...
const mapStateToProps = state => {
  return {ages: state.ages.ages, term: state.term.term, categories: state.categories.categories, selectedCategory: state.categories.selectedCategory}
}
...
const Search = withRouter(connect(mapStateToProps, mapDispatchToProps)(SearchContainer))
