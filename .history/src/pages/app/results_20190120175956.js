...
const ResultsPage = (props) => (
    <AppLayout>
        ...
        <div>
            {this.props.location.state.selectedItem && <Result item={this.props.location.state.selectedItem}/> < /div>
        <div>
            <Results hideLoadMore={false} searchParams={props.location.state.search}/ > </div> < Link to = "/" > Go to page home < /Link>
    </AppLayout >)
