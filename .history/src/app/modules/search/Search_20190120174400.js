...
class Search extends React.Component {
    ...
    render() {
        return (
            <div>
                <Select value={this.state.value} loadOptions={promiseOptions} defaultOptions={defaultOptions} // options={groupedOptions(this.state.value)
            }} getOptionLabel={option => option.name} getOptionValue={option => option.id} formatGroupLabel={formatGroupLabel} onChange={this.onChange} onInputChange={this.onInputChange}/>
            </div>
        )
    }
}
