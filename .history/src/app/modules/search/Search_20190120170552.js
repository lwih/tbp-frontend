...
class Search extends React.Component {
    ...
    render() {
        return (
            <div>
                <Select value={this.state.value} // inputValue={this.state.inputValue
            }} options={groupedOptions} getOptionLabel={option => option.name} getOptionValue={option => option.id} formatGroupLabel={formatGroupLabel} onChange={this.onChange} onInputChange={this.onInputChange}/>
            </div>
        )
    }
}
