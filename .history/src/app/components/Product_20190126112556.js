...
const showMobileProduct = (props, select) => {
    ...
    //      : ''}/>     </Flexbox>     <Flexbox flexBasis="100%"
    // justifyContent="center" marginTop="5px">       <div
    // className="ProductButtonLink">         <button className="ProductButton">
    //       <Translate content="product.goToDetails"/>         </button>
    // </div>     </Flexbox>   </Flexbox> </Flexbox>
    )
}
...
const showDesktopProduct = (props, select) => {
    ...
    // justifyContent="flex-start" marginTop="5px">     <Price
    // price={product.price       ? product.price.displayPrice       : ''}/>
    // </Flexbox>   <Flexbox flexBasis="90%" justifyContent="center"
    // marginTop="5px">     <ProductButton onClick={select}
    // translationKey="product.goToDetails"/>   </Flexbox> </Flexbox>
    )
}
